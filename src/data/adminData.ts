...
export const mockUsers: User[] = [
  { id: '1', name: 'Priya Mehta', email: 'priya.mehta@exco.com', role: 'Compliance Officer', department: 'Legal & Compliance', lastLogin: '2026-03-29 09:15', status: 'Active', assignedOwner: 28, assignedApprover: 0 },
  { id: '2', name: 'Rajesh Kumar', email: 'rajesh.kumar@exco.com', role: 'Company Secretary', department: 'Corporate Secretarial', lastLogin: '2026-03-29 08:30', status: 'Active', assignedOwner: 35, assignedApprover: 15 },
  { id: '3', name: 'Anjali Desai', email: 'anjali.desai@exco.com', role: 'Compliance Officer', department: 'Legal & Compliance', lastLogin: '2026-03-28 17:45', status: 'Active', assignedOwner: 20, assignedApprover: 0 },
  { id: '4', name: 'Vikram Singh', email: 'vikram.singh@exco.com', role: 'Administrator', department: 'IT', lastLogin: '2026-03-29 10:00', status: 'Active', assignedOwner: 0, assignedApprover: 0 },
  { id: '5', name: 'Neha Sharma', email: 'neha.sharma@exco.com', role: 'Board Member', department: 'Board', lastLogin: '2026-03-25 14:00', status: 'Active', assignedOwner: 0, assignedApprover: 25 },
  { id: '6', name: 'Arjun Patel', email: 'arjun.patel@exco.com', role: 'Auditor', department: 'Internal Audit', lastLogin: '2026-03-27 11:30', status: 'Active', assignedOwner: 10, assignedApprover: 18 },
  { id: '7', name: 'Sunita Rao', email: 'sunita.rao@exco.com', role: 'Legal Counsel', department: 'Legal', lastLogin: '2026-03-28 16:20', status: 'Active', assignedOwner: 0, assignedApprover: 35 },
  { id: '8', name: 'Amit Gupta', email: 'amit.gupta@exco.com', role: 'Viewer', department: 'Finance', lastLogin: '2026-03-20 09:00', status: 'Inactive', assignedOwner: 0, assignedApprover: 0 },
];
